...
data = {
    ...
    'StoreID': np.random.randint(1,201,size=num_rows),
    'CustomerID': np.random.randint(1,10001,size=num_rows),
...
df.to_csv('C:/Users/aksha/Documents/SQL/EndtoEndSalesProject-master/retail_data/FactOrders/factorders.csv',index=False)


out = pd.read_csv('C:/Users/aksha/Documents/SQL/EndtoEndSalesProject-master/retail_data/FactOrders/factorders.csv')
out.info()
