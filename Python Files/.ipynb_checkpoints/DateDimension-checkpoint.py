...
date_dimension.to_csv('C:/Users/aksha/Documents/SQL/EndtoEndSalesProject-master/retail_data/DimDate/Dimdate.csv',index=False)

df=pd.read_csv("C:/Users/aksha/Documents/SQL/EndtoEndSalesProject-master/retail_data/DimDate/Dimdate.csv")
df.head()
